...
struct MealCard: View {
    ...
    private func emoji(for food: String) -> String {
        ...
        case _ where lower.contains("cereal"): return "🥣"
        case _ where lower.contains("spaghetti") || lower.contains("pasta"): return "🍝"
        case _ where lower.contains("burger") || lower.contains("sandwich"): return "🍔"
        case _ where lower.contains("pizza"): return "🍕"
        case _ where lower.contains("bagel"): return "🥯"
        case _ where lower.contains("taco"): return "🌮"
        case _ where lower.contains("croissant"): return "🥐"
        case _ where lower.contains("soup"): return "🍲"
        case _ where lower.contains("hotdog"): return "🌭"
        case _ where lower.contains("pancake"): return "🥞"
        case _ where lower.contains("waffle"): return "🧇"
        case _ where lower.contains("cookie") || lower.contains("biscuit"): return "🍪"
        case _ where lower.contains("cake"): return "🍰"
        case _ where lower.contains("ice cream"): return "🍨"
        case _ where lower.contains("donut"): return "🍩"
        case _ where lower.contains("fries"): return "🍟"
        case _ where lower.contains("sandwich"): return "🥪"
        case _ where lower.contains("juice"): return "🧃"
        case _ where lower.contains("shake") || lower.contains("smoothie"): return "🥤"
        case _ where lower.contains("candy"): return "🍬"
